          ...
          <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
            <div>
              <p className="text-3xl text-center">
                Start your <span className="text-fresh">Journey</span> for
                enjoyable food!
              </p>
            </div>
            <div className="flex items-start mt-8">
              ...
              <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5 mr-6">
                BudgetBite has saved me the stress of planning my grocery run,
                all I have to worry about now is cooking the delicious recipes
                that they pick for me!{" "}
